...
public class BoardFileUtils {
	public List<BoardFileVO> parseFileInfo(int bno, MultipartHttpServletRequest multipartHttpServletRequest) throws Exception {
		//비어있을 경우 이 문장에서 끝
		...
		while (iterator.hasNext()) {
			...
			for (MultipartFile multipartFile : list) {
				...
				if (multipartFile.isEmpty() == false) {
					...
					boardFile.setI_filename(multipartFile.getOriginalFilename());
					boardFile.setI_path(path + "/" + newFileName);
